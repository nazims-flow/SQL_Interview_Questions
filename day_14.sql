...
VALUES
    (946, 123, 'Data Analyst', 'Data analyst reviews data to identify key insights into a business''s customers and ways the data can be used to solve problems.'),
...
SELECT 
   COUNT(company_id) as cnt_company
FROM
(SELECT company_id,
       title,
	   description,
